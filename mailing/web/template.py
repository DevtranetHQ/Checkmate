def template(guildName, code):
    ...
    <body>
        <span class="preheader"
            >Authentication code for %s's discord server.</span
        >
                                    ...
                                    >
                                        <tr>
                                            <td>
                                                ...
                                                <br />
                                                <p>
                                                    Use it to unlock Devtranet's
                                                    discord server, it expires
                                                    in 15 minutes, enjoy!
                                                </p>
                            ...
                            >
                                ...
                                <tr>
                                    <td class="content-block powered-by">
                                        © Devtranet, the official network for
                                        Developers.
                                    </td>
                                </tr>
                            </table>
